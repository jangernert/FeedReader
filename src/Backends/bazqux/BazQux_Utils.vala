...
public class FeedReader.bazqux_utils : GLib.Object {

	public static string getUser()
	{
		return settings_bazqux.get_string ("username");
	}

	public static string getAccessToken()
	{
		return settings_bazqux.get_string ("access-token");
	}

	public static string getUserID()
	{
		return settings_bazqux.get_string ("user-id");
	}
