...
// FIXME: use granite once its in the fedora repos
...
public class  ThinPaned : Gtk.Paned {
    ...
    private const string DEFAULT_STYLESHEET = """
        ThinPaned { -GtkPaned-handle-size: 1px; }
    """;

    private const string FALLBACK_STYLESHEET = """
        ThinPaned.sidebar-pane-separator {
    ...
    public override bool draw (Cairo.Context ctx) {
        ...
        style_context.save ();
        style_context.add_class ("sidebar-pane-separator");
